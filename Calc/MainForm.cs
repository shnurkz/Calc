    ...
    public partial class MainForm : MetroFramework.Forms.MetroForm
    {
        ...
        public void AddAccountRowToInterface(string accountName, double value1 = 0, double value2 = 0, double balance = 0)
        {
            ...
            Label balanceLabel = new Label
            {
                ...
                AutoSize = true,
                Text = balance.ToString() + " ₸" // Добавляем знак тенге
            };
        ...
        private void TextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                // Разрешить любые символы для textBox2
                return;
            }
            else
            {
                // Разрешить только цифры и управляющие символы для других текстовых полей
